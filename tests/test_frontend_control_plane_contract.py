...
class FrontendControlPlaneContractTests(unittest.TestCase):
    ...
    def test_studio_org_and_copy_pipeline_persist_across_reload(self) -> None:
        ...
        self.assertIn("[runId, deviceId, agentId, run.device_id, run.owner_type, run.owner_id, plateOwner, paired, busy, reloadToken, refreshToken]", workspace)
        self.assertIn("listRunsAcrossOwners", studio)
        ...
        self.assertIn("storedOwnerKeys", workspace)
        ...
        self.assertIn("plateOwner", studio)
