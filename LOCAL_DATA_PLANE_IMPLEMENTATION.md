...
| Mongo-backed dashboard configs | Complete (repository) | `7573c6f`, `4137e27`, plus frontend cache follow-up | 8 focused Mongo config tests, 153 full regression tests, standalone smoke assertions, backend/frontend compilation, and lints pass | Restores all eight personal/org config files, removes the legacy Studio content route, forces frontend asset revalidation, and validates production config endpoints plus MongoDB's document limit |
