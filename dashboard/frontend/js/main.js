    ...
    const queued = await fetchJSON(`/api/runs/${encodeURIComponent(envelope.run_id)}/structured-copy`, {
      ...
      body: JSON.stringify({
        ...
        settings: {
          ...
          reuse_backgrounds_from_run_id: cfg.reuse_backgrounds_from_run_id,
          reuse_visual_patterns_from_run_id: cfg.reuse_visual_patterns_from_run_id,
          hypothesis: cfg.hypothesis,
          visual_archetypes_by_format: cfg.visual_archetypes_by_format,
